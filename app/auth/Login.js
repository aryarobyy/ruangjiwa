        ...
        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6">
            ...
            <input
              ...
              id="Email"
              name="email"
              className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-md block p-2.5" placeholder="name@flowbite.com" required
            />
          </div>
          ...
          <div className="col-span-6">
            ...
            <input
              ...
              id="Password"
              name="password"
              className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-md block p-2.5" placeholder="Password" required
            />
          </div>
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:mt-0">
              Belum Punya Akun? 
              <a href="#" className="text-gray-700 underline p-1">Sign In</a>.
            </p>
          </div>
        </form>
      </div>
