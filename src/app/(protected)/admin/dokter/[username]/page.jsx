            ...
            <div className="w-full max-w-full mx-auto p-4 shadow-xl rounded-lg text-gray-900 bg-primary">
                ...
                <div className="flex-grow">
                    <div className="text-left">
                        <p className="text-gray-500 ml-2">Username: @{username} </p>
                        <h2 className="font-medium text-2xl ml-2">Nama: {name}</h2>
                        <h3 className="font-medium text-2xl ml-2">Spesialis: Spesialis</h3>
